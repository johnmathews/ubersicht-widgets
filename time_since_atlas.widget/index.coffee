...
command: "osascript 'Time_Since_atlas.widget/Time_Since.applescript' \"#{options.theDate}\""
...
update: (output, dom) ->
  ...
  time_str = options.startPhrase + ' ' + values[0] + y + values[2]  + m + values[4] + d + options.endPhrase ;
